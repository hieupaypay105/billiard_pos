...
class KhachHangAddScreen extends StatefulWidget {
  const KhachHangAddScreen({super.key});

  @override
  State<KhachHangAddScreen> createState() => _KhachHangAddScreenState();
}

class _KhachHangAddScreenState extends State<KhachHangAddScreen> {
  ...
  Future<void> _onDone() async {
    ...
    final success = await provider.createCustomer(data: data);
      ...
      body: Container(
        ...
        child: SafeArea(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: MediaQuery.paddingOf(context).top + 100),
              Expanded(
                child: Padding(
                ...
                children: [
                  khHangFieldRow(
                    left: khHangFieldColumn(
                      ...
                      child: khHangFormDropdown<int>(
                        ...
                        items: provider.options!.region.entries
                            .map(
                              (e) => DropdownMenuItem(
                                value: e.key,
                                child: Text(e.value),
                  ...
                  khHangFieldColumn(
                    ...
                    child: khHangFormDropdown<int>(
                      ...
                      items: provider.options!.project.entries
                          .map(
                            (e) => DropdownMenuItem(
                              value: e.key,
                              child: Text(e.value),
                  ...
                  khHangFieldRow(
                    left: khHangFieldColumn(
                      ...
                      child: khHangFormDropdown<String>(
                        ...
                        items: provider.options!.financialRange.entries
                            .map(
                              (e) => DropdownMenuItem(
                                value: e.key,
                                child: Text(e.value),
                    ...
                    right: khHangFieldColumn(
                      label: 'Tình trạng',
                      child: khHangFormMultiSelectSheet<int>(
                        name: _fStatus,
                  ...
                  khHangFieldRow(
                    ...
                    right: khHangFieldColumn(
                      ...
                      child: khHangFormDropdown<int>(
                        ...
                        items: provider.options!.source.entries
                            .map(
                              (e) => DropdownMenuItem(
                                value: e.key,
                                child: Text(e.value),
