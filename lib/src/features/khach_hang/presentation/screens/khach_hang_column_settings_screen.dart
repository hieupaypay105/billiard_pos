...
class KhachHangColumnSettingsScreen extends StatelessWidget {
  const KhachHangColumnSettingsScreen({super.key});
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...KhachHangProvider.columnOrder.map(
                              (key) => Padding(
                                padding: const EdgeInsets.only(top: 2),
                                child: _SettingsRow(
                                  label:
                                      KhachHangProvider.columnLabels[key] ??
                                      key,
                                  checked:
