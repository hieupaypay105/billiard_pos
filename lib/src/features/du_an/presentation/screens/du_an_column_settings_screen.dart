...
class DuAnColumnSettingsScreen extends StatelessWidget {
  const DuAnColumnSettingsScreen({super.key});
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...DuAnProvider.columnOrder.map(
                              (key) => Padding(
                                padding: const EdgeInsets.only(top: 2),
                                child: _SettingsRow(
                                  label: DuAnProvider.columnLabels[key] ?? key,
                                  checked:
