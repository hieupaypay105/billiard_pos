...
class DuAnAddScreen extends StatefulWidget {
  const DuAnAddScreen({super.key});

  @override
  State<DuAnAddScreen> createState() => _DuAnAddScreenState();
}

class _DuAnAddScreenState extends State<DuAnAddScreen> {
  ...
  Future<void> _onDone() async {
    ...
    if (success) {
      ...
      if (fieldErrors != null && fieldErrors.isNotEmpty) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(provider.submitError ?? 'Thêm mới thất bại'),
            backgroundColor: Colors.red,
          ),
        );
      }
