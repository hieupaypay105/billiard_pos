...
class QuanTriFilterSheet extends StatefulWidget {
  const QuanTriFilterSheet({
  ...
  final ValueChanged<QuanTriFilter> onApply;

  @override
  State<QuanTriFilterSheet> createState() => _QuanTriFilterSheetState();
}

class _QuanTriFilterSheetState extends State<QuanTriFilterSheet> {
