...
class QuanTriAddScreen extends StatefulWidget {
  const QuanTriAddScreen({super.key});

  @override
  State<QuanTriAddScreen> createState() => _QuanTriAddScreenState();
}

class _QuanTriAddScreenState extends State<QuanTriAddScreen> {
  final _formKey = GlobalKey<FormBuilderState>();

  static const _fFullname = 'fullname';
  static const _fEmployeeCode = 'employee_code';
  static const _fUsername = 'username';
  static const _fPassword = 'password';
  static const _fPasswordConfirm = 'password_confirmation';
  ...
  Future<void> _onDone() async {
    ...
    // Quick checks
    final pass = (formData[_fPassword] as String?) ?? '';
    final passConfirm = (formData[_fPasswordConfirm] as String?) ?? '';
    if (pass != passConfirm) {
    ...
    final data = <String, dynamic>{
      ...
      'password': pass.trim(),
      'password_confirmation': passConfirm.trim(),
    ...
    final success = await provider.createItem(data: data);
      ...
      body: Container(
        ...
        child: SafeArea(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: MediaQuery.paddingOf(context).top + 90),
              Expanded(
