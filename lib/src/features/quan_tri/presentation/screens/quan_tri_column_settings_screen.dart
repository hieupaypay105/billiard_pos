...
class QuanTriColumnSettingsScreen extends StatelessWidget {
  const QuanTriColumnSettingsScreen({super.key});
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Consumer<QuanTriProvider>(
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...QuanTriProvider.columnOrder.map(
                              (key) => Padding(
                                padding: const EdgeInsets.only(top: 2),
                                child: _SettingsRow(
                                  label:
                                      QuanTriProvider.columnLabels[key] ?? key,
                                  checked:
