...
class OrderModel extends Equatable {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) {
    return OrderModel(
      ...
      totalPlayTimeMinutes: int.tryParse(json['total_play_time_minutes']?.toString() ?? '') ?? 0,
      totalPlayTimeAmount: double.tryParse(json['total_play_time_amount']?.toString() ?? '') ?? 0.0,
      totalProductAmount: double.tryParse(json['total_product_amount']?.toString() ?? '') ?? 0.0,
